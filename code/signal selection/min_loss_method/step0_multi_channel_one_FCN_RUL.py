...
for FD in['3']:
    ...
    for i_all_feature_columns in range(len(all_feature_columns)):
        ...
        #                  verbose=1, validation_data=(X_test, Y_test), callbacks = [reduce_lr,earlystopping,modelcheckpoint])   
                ...
                log.to_excel(last_last_last_path+r"\experiments_result\log\feature_select_valid0\feature_select_valid0\{}_{}_log{}.xlsx".format(method_name,all_feature_columns[i_all_feature_columns],i))
