...
# note:to reduce the size of the compressed package, we only provide the model of LM+TaNet. You only need to change model_name_list[0] in 317 and 378 line if you want to replace it with another model
...
for i in range(ID,ID+1):
 ...
 #  40,  100 ,  46 , 7
    ...
    plt.legend()
    plt.savefig(r'..\..\figure\by_kernel\prediction_error{}_{}.eps'.format(FD,id_num),dpi=800,format='eps',bbox_inches = 'tight')
