...
for k in range(100):
    ...
    plt.colorbar();
    # plt.legend()
    # plt.savefig(r'F:\桌面11.17\project\RUL\figure\by_kernel\interpretability\{}_{}.eps'.format(model_name,k),dpi=800,format='eps',bbox_inches = 'tight')
    # plt.savefig(r'F:\桌面11.17\project\RUL\figure\by_kernel\interpretability\{}_{}.png'.format(model_name,k),dpi=800,format='png',bbox_inches = 'tight')
    plt.show()
